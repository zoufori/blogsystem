package com.jimmy.blogsystem.web.admin;
...
public class AdminController {
    ...
    @ResponseBody
    public ArticleResponseData publishArticle(Article article) throws Exception{
    ...
    public String index(HttpServletRequest request) throws Exception{
        //获取最新的5篇博客、评论以及统计数据
        List<Article> articles = siteServiceImpl.recentArrticles(5);
    ...
    public String editArticle(@PathVariable("id")String id, HttpServletRequest request) throws Exception{
    ...
    @ResponseBody
    public ArticleResponseData modifyArticle(Article article) throws Exception{
        try{
    ...
    @ResponseBody
    public ArticleResponseData delete(@RequestParam int id) throws Exception{
        try{
