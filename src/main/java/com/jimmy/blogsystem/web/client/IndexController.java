...
public class IndexController {
    ...
    //博客首页，会自动跳转到文章页
    @GetMapping(value = "/")
    private String index(HttpServletRequest request) throws Exception{
    ...
    public String getArticleById(@PathVariable("id")Integer id, HttpServletRequest request) throws Exception {
    ...
    private void getArticleComments(HttpServletRequest request, Article article) throws Exception {
