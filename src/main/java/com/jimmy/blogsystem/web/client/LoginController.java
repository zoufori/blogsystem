...
public class LoginController {
    ...
    public String login(HttpServletRequest request, Map map){
        ...
        if(url != null && url.equals("")){
            map.put("url", url);
            //如果请求头本身包含登录，将重定向url为空，让后台通过用户觉得进行选择跳转
    ...
    public String AccessExceptionHandler(@PathVariable("page")String page, @PathVariable("code")String code) throws Exception{
        return page + "/" + code;
    }
}
